...
class SaleProductDetailPage extends StatefulWidget {
  final SaleProductdetail product;

  const SaleProductDetailPage({Key? key, required this.product})
      : super(key: key);

  @override
  MySaleProductDetailPage createState() => MySaleProductDetailPage();
}

class MySaleProductDetailPage extends State<SaleProductDetailPage> {
  ...
  Widget build(BuildContext context) {
    SaleProductdetail product = widget.product;
    return Scaffold(
            ...
            Row(
              children: [
                Text(
                  ...
                  style: const TextStyle(
                    fontSize: 18,
                    color: Color.fromARGB(208, 255, 56, 56),
                    decoration: TextDecoration.lineThrough,
                    decorationColor: Color.fromARGB(255, 255, 56, 56),
